    ...
    <main className={styles.previewMain}>
      <div className={styles.previewMainContent}>
        <div className={styles.previewLogo}>
          <h2 className={styles.previewSubtitle}>
            Всем привет,
            <br /> с вами
          </h2>
          <h1 className={styles.previewTitle}>Ярослав Бесфалин</h1>
          <p className={styles.previewParagraph}>
            Я разработчик, который работает в не стандартных условиях, энтузиаст, исследователь
            технологий. Делаю веб-проекты и делюсь опытом в блоге.
          </p>
